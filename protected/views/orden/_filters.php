...
<?php
    ...
    echo Chtml::dropDownList('Operadores', '', array('>' => '>', '>=' => '>=',
                            '=' => '=', '<' => '<', '<=' => '<=', '<>' => '<>'), 
                                array('empty' => 'Operador',
                                    'style' => 'display:none'));
    echo CHtml::dropDownList('estado', '', array('0' => 'Pendiente',
                                                       '1' => 'Aprobada',
                                                       '2' => 'Rechazada',
                                                       ),
   ...
   /* echo CHtml::dropDownList('looks_ps', '', CHtml::listData(User::model()->with(array(
    ...
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/filtersOrdenes.js");
                    ...
                    <div class="col-md-12">
                        <div class="span3" >
                            ...
                            $opcionesFiltros = array(
                                ...
                                'empresaVendedora'=>'Empresa vendedora',
                                'usuarioVendedor'=>'Usuario vendedor',
                                'empresaCompradora'=>'Empresa compradora',
                                'usuarioComprador'=>'Usuario comprador',
                                'montoSinIva'=>'Monto sin IVA',
                                'montoConIva'=>'Monto con IVA',
                                'fechaUltimaAccion'=>'Fecha de ultima accion',
                                'estado'=>'Estado',
                                 );
