...
<?php
  ...
  //  }
    ...
    echo '<h2> '.$producto->nombre.' <h4><small><a href="#">por '.$marca->nombre.'</a></small></h4></h2>';
    ...
    echo '<h4 class="text-danger">Bs. '.$inventario_menor_precio->precio.' </h4>
    		<div class="row">
    			<a role="button" href="'.Yii::app()->baseUrl.'/bolsa/agregar/'.$producto->id.'" class="btn btn-xs btn-success btn-default">Comprar ahora »</a>
    		</div> ';
