<div style="font-size: 14px;">
	...
	Haz click <a href="<?php echo 'http://' . $_SERVER['HTTP_HOST'].Yii::app()->createUrl('empresas/uploadFiles/id/'.$empresas->id.'/tipo/recordatorio');?>">aquí</a> y adjunta tus documentos.
    </div>
