    ...
    echo Chtml::dropDownList('Operadores', '', array('>' => '>', '>=' => '>=',
                            '=' => '=', '<' => '<', '<=' => '<=', '<>' => '<>'), 
                                array('empty' => 'Operador',
                                    'style' => 'display:none'));
    echo CHtml::dropDownList('status', '', array('0' => 'Inactivo',
                                                       '1' => 'Activo',
                                                       ),
                            array('class'=>'form-control','style' => 'display:none'));
							
echo CHtml::dropDownList('destacado', '', array('0' => 'No destacada',
                                                       '1' => 'Destacada',
                                                       ),
                            array('class'=>'form-control','style' => 'display:none'));

    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/filters.js");
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/filtersMarcas.js");
