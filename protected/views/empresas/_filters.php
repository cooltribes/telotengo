...
<?php
    ...
    echo CHtml::dropDownList('tipo_contribuyente', '', array(0 => 'Contribuyente Ordinario',
                                                             1 => 'Contribuyente Especial',
                                                             2 => 'Contribuyente Formal',),
                            array('style' => 'display:none'));

    echo CHtml::dropDownList('rol', '',array(
                                                            'comprador' =>'Comprador',
                                                            'vendedor'=> 'Vendedor',
                                                            'compraVenta' => 'Comprador/Vendedor',),
                            array('style' => 'display:none'));

    echo CHtml::dropDownList('sector', '', array(
                                                            1 => 'Alimentos y Bebidas',
                                                            2 => 'Comercio al Mayor',
                                                            3 => 'Comercio al Detal',
                                                            4 => 'Industrial',
                                                            5 => 'Construcción y Bienes Raíces',
                                                            6 => 'Entretenimiento',
                                                            7 => 'Hoteleria y Turismo',
                                                            8 => 'Informática y Telecomunicaciones',
                                                            9 => 'Salud y Belleza',
                                                            10 => 'Servicios Profesionales',
                                                            11 => 'Automotríz y Transporte',
                                                            12 => 'Agropecuaria',
                                                            13 => 'Banca y Finanzas',
                                                            14=> 'Educación',   
                                                            15 => 'Energía y Minería',
                                                             ),
                            array('style' => 'display:none'));
    
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/filters.js");
    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl."/js/filtersEmpresas.js");
