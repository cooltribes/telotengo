	...
	<td>
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				<li><a tabindex="-1" href="update/<?php echo $data->id; ?>" ><i class="icon-cog"></i> Editar </a></li>
				<li><a tabindex="-1" href="delete/<?php echo $data->id; ?>" ><i class="icon-trash"></i> Eliminar </a></li>
			</ul>
		</div>
	</td>
