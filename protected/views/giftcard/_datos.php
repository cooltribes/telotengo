<tr>	 
	...
	<td><?php echo date('d/m/Y',strtotime($data->inicio_vigencia)); ?></td>
	<td><?php echo date('d/m/Y',strtotime($data->fin_vigencia)); ?></td>
	<td class="text-right"><?php echo $data->monto; ?></td>
