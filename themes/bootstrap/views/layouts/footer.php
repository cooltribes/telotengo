                  ...
                  <div class="row-fluid">
                      ...
                      <div class="col-md-4 padding_left padding_right">
                          <div style="width:100%;" class="padding_right padding_left">
                              ...
                              <img height="41px" src="<?php echo Yii::app()->theme->baseUrl;?>/images/layout/facebook2.png" alt="Facebook">
                              <img height="41px" src="<?php echo Yii::app()->theme->baseUrl;?>/images/layout/twitter2.png" alt="Twitter" style="margin-left: 8px;">
                          </div>
                      </div>
                  </div>
              </div>
          </div>
          <div style="background-color:BLACK;" class="padding_bottom_small">
              <div class="container">
                <div class="row-fluid">
                  <div class="col-md-5 padding_left padding_right col-md-offset-3 " style="margin-top: 10px;">
                   <b style="color:WHITE;">© 2016 </b><b class="number highlighted">Telotengo.com </b><b style="color:WHITE;">| Todos los derechos reservados.</b>
                  </div>
                </div>
              </div>
          </div>